...
def findAllNextStates(gc, n, timeStep, cellTypeNode, cellTypeTree, currentStates, cellTypesRecord, noiseDisp, convergenceThreshold, maxNumIterations, convDistAvgNum, numToSample, geneMeanLevels, showPlots, cellDevelopmentMode):
	...
	for cellTypeNodeChildID in cellTypeNodeChildrenIDs:
		...
		findAllNextStates(gc, n, timeStep, cellTypeNodeChild, cellTypeTree, currentStates, cellTypesRecord, noiseDisp, convergenceThreshold, maxNumIterations, convDistAvgNum, numToSample, geneMeanLevels, showPlots, cellDevelopmentMode)
...
def main():
	...
	###Step 1 - Choose the number of genes (n)###
	...
	cellTypeParents = [-1, 0, 0]
	cellTypeNumCells = [100, 300, 300]
	cellTypeConstProbs = [0.05, 0.05, 0.05] #Inherited
	cellTypeMeans = [0, 0, 0] #Not inherited
	targetNumCellTypes = 2
	...
	gc, transcriptionFactors = generateGeneCorrelationMatrix(n, maxAlphaBeta, normalizeWRows, networkStructure, powerLawExponent, networkSparsity, saveFolder)
	...
	findAllNextStates(gc, n, timeStep, cellTypeTree.head(), cellTypeTree, currentStates, cellTypesRecord, noiseDisp, convergenceThreshold, maxNumIterations, convDistAvgNum, numToSample, geneMeanLevels, showPlots, cellDevelopmentMode)
