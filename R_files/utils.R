...
savePlots <- function(dataList) {
  #currentDir = getwd()
  currentDir = "/home/scornwell/Internship/R_files/Saved_Plots"
  plotDir = paste(currentDir, "/", gsub(" ","_",Sys.time()), sep="")
  dir.create(plotDir)
  setwd(plotDir)
  
  tiff('means.tiff')
  plot(dataList$Diff$Plots$Means)
  dev.off()
  
  tiff('variances.tiff')
  plot(dataList$Diff$Plots$Variances)
  dev.off()
  
  tiff('meanVar.tiff')
  plot(dataList$Diff$Plots$MeanVar)
  dev.off()
  
  tiff('librarySizes.tiff')
  plot(dataList$Diff$Plots$LibrarySizes)
  dev.off()
  
  tiff('zerosGene.tiff')
  plot(dataList$Diff$Plots$ZerosGene)
  dev.off()
  
  tiff('zerosCell.tiff')
  plot(dataList$Diff$Plots$ZerosCell)
  dev.off()
  
  tiff('meanZeros.tiff')
  plot(dataList$Diff$Plots$MeanZeros)
  dev.off()
  
  tiff('meansQQ.tiff')
  plot(dataList$Diff$QQPlots$Means)
  dev.off()
  
  tiff('variancesQQ.tiff')
  plot(dataList$Diff$QQPlots$Variances)
  dev.off()
  
  tiff('librarySizesQQ.tiff')
  plot(dataList$Diff$QQPlots$LibrarySizes)
  dev.off()
  
  tiff('zerosGeneQQ.tiff')
  plot(dataList$Diff$QQPlots$ZerosGene)
  dev.off()
  
  tiff('meansComp.tiff')
  plot(dataList$Comp$Plots$Means)
  dev.off()
  
  tiff('variancesComp.tiff')
  plot(dataList$Comp$Plots$Variances)
  dev.off()
  
  tiff('meanVarComp.tiff')
  plot(dataList$Comp$Plots$MeanVar)
  dev.off()
  
  tiff('librarySizesComp.tiff')
  plot(dataList$Comp$Plots$LibrarySizes)
  dev.off()
  
  tiff('zerosGeneComp.tiff')
  plot(dataList$Comp$Plots$ZerosGene)
  dev.off()
  
  tiff('zerosCellComp.tiff')
  plot(dataList$Comp$Plots$ZerosCell)
  dev.off()
  
  tiff('meanZerosComp.tiff')
  plot(dataList$Comp$Plots$MeanZeros)
  dev.off()
